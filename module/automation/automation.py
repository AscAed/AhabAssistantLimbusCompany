...
class Automation(metaclass=SingletonMeta):
    ...
    def find_feature_element(self, target, pic_crop=None, min_matches=8, additional_stack=0):
        ...
        try:
            ...
            # ⚡ Bolt: Reorder scales to prioritize native scale (1.0) and avoid unnecessary resizing overhead.
            ...
            for scale in scales:
                ...
                # ⚡ Bolt: Fast-path early exit. If native scale matches, skip costly resize and matchTemplate for other scales.
